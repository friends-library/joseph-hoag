...
_Answer,_ "`Yes.`"
__Question--__"`Is there any way to get into heaven, but by Christ, the door?`"
_Answer,_ "`No.`" __Question--__"`Are they ever turned out when once admitted.`"
_Answer,_ "`No.`" I then remarked,
...
"`Joseph, I am glad thou hast been favored to keep thy place today.`"
...
__Question--__"`Dost thou feel no disagreeable feelings when in his company?`"
...
The answer was,
"`No.`" __Question--__"`Did you know of it as long ago as when he offered his service?`"
The answer was, "`Yes.`"
__Question--__"`Why have you lain still?`"
