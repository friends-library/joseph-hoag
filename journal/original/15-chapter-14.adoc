...
Little Blue River, Sandy Creek, Driftwood, Blue River, Beech Grove, Lick Creek,
...
Gurney Settlement, and Kingsbury; the latter a crowded meeting in a schoolhouse;
